...
@Component
@Slf4j
public class IsOnlyOnePlayerUnfoldedGuard extends BaseGuard {
    public IsOnlyOnePlayerUnfoldedGuard(GameTableRegistry gameTableRegistry) {
    ...
    public boolean evaluate(StateContext<GameState, GameEvent> context) {
        ...
        return game.isOnlyOnePlayerUnfolded();
    }
}
